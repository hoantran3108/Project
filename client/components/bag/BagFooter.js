...
const BagFooter = ({ openModalRemove, closeModalRemove, isModalRemoveOpen, removeProducts, total, redirectToShop, ...rest }) => (
  <Table.Footer fullWidth>
    <Table.Row>
      <Table.HeaderCell>
        <Modal trigger={<Button onClick={openModalRemove}>Remove All</Button>} onClose={closeModalRemove} open={isModalRemoveOpen} size='small'>
      ...
      <Table.HeaderCell colSpan='4'>
        ...
        {checkoutButton({content: 'Check out', ...rest})}
      </Table.HeaderCell>
      <Table.HeaderCell>
      ${total}
      </Table.HeaderCell>
